...
<%
	pageContext.setAttribute("roleType",EducationConstant.TEACHER_USER_ROLE);
%>
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="10" bgcolor="#F0F0FF">
	<tr>
		...
		<td colspan="1" width="10">
			<label>
			<html:form styleId="userListFormID" action="/newUserTeacherListAction.do" method="POST">
	...
	<tr>
		...
		<td colspan="0" colspan="0" align="left">
...
<display:table id="row" name="NewUserBean.pgSearchResults" 
	 requestURI="/newUserTeacherListAction.do"
