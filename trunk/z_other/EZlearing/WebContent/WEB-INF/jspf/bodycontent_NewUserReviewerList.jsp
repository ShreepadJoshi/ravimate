...
<%
	pageContext.setAttribute("roleType",EducationConstant.REVIEWER_USER_ROLE);
%>
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="10" bgcolor="#F0F0FF">
	<tr>
		...
		<td colspan="1" align="left">
			<label>
			<html:form styleId="userListFormID" action="/newUserReviewerListAction.do" method="POST">
		...
		<td colspan="1" height="30" align="right" valign="middle">
			<a onclick="document.getElementById('userListFormID').submit();">
	...
	<tr>
		...
		<td colspan="1" align="left">
		<html:text property="sch_EmailID" styleClass="input_field" maxlength="50" size="20" />
		</td>
	</tr>
	<tr>
...
<display:table id="row" name="NewUserBean.pgSearchResults" 
	 requestURI="/newUserReviewerListAction.do"
	 decorator="com.education.displaytag.NewUserListTableDecorator" style="width:100%">	
	...
	<display:footer>
		...
		<html:submit property="action" value="DisableReviewer" styleClass="url"/>		
	</display:footer>
