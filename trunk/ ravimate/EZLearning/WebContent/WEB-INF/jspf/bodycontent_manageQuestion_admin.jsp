		...
		<table width="100%" border="0" align="left" cellpadding="5" cellspacing="1">			
			...
			<tr>
				...
				<div id="ManageQsubTopic_divID">
					<html:select styleClass="input_field" styleId="subtopicId" property="subTopicId">
				...
				<td colspan="4">
					...
					<html:textarea property="question" cols="50" rows="3" styleClass="input_field" styleId="question"/>					
					 <logic:equal value="1" property="isGraphics" name="ManageQuestionBean" >
					 	...
					 	<br/><html:radio property="questionImg_editAction" value="update" onclick="enableImgInputForID('questionImage')">Add/UpdateImage</html:radio>
					 	&nbsp;<html:radio property="questionImg_editAction" value="remove" onclick="disableImgInputForID('questionImage')">RemoveImage</html:radio>
					 	&nbsp;<html:radio property="questionImg_editAction" value="none" onclick="disableImgInputForID('questionImage')">Do Nothing</html:radio>			  
					...
					<html:textarea property="option1" cols="50" rows="3" styleClass="input_field" styleId="option1"/>
					 <logic:equal value="1" property="isGraphics" name="ManageQuestionBean" >
						<br/><img id="option1_ImageValue" src="<html:rewrite page='/imageRender.do'/>?questionId=<%=qId %>&imagefor=<%=EducationConstant.IMAGE_FOR_OPTION1%>"
						  		   alt="NoImage" height="100" width="100"/>
						 <br/><html:radio property="option1Img_editAction" value="update" onclick="enableImgInputForID('ansOneImage')">Add/UpdateImage</html:radio>
						 &nbsp;<html:radio property="option1Img_editAction" value="remove" onclick="disableImgInputForID('ansOneImage')">RemoveImage</html:radio>
						 &nbsp;<html:radio property="option1Img_editAction" value="none" onclick="disableImgInputForID('ansOneImage')">Do Nothing</html:radio>
					...
					<html:textarea property="option2" cols="50" rows="3" styleClass="input_field" styleId="option2"/>
					 <logic:equal value="1" property="isGraphics" name="ManageQuestionBean" >
						<br/> <img id="option2_ImageValue" src="<html:rewrite page='/imageRender.do'/>?questionId=<%=qId %>&imagefor=<%=EducationConstant.IMAGE_FOR_OPTION2%>"
						  		   alt="NoImage" height="100" width="100"/>
						 <br/><html:radio property="option2Img_editAction" value="update" onclick="enableImgInputForID('ansTwoImage')">Add/UpdateImage</html:radio>
						 &nbsp;<html:radio property="option2Img_editAction" value="remove" onclick="disableImgInputForID('ansTwoImage')">RemoveImage</html:radio>
						 &nbsp;<html:radio property="option2Img_editAction" value="none" onclick="disableImgInputForID('ansTwoImage')">Do Nothing</html:radio>
				...
				<td colspan="4">
					...
					<logic:equal value="1" property="isGraphics" name="ManageQuestionBean" >
						<br/><img id="option3_ImageValue" src="<html:rewrite page='/imageRender.do'/>?questionId=<%=qId %>&imagefor=<%=EducationConstant.IMAGE_FOR_OPTION3%>"
						  		   alt="NoImage" height="100" width="100"/>
						<br/><html:radio property="option3Img_editAction" value="update" onclick="enableImgInputForID('ansThreeImage')">Add/UpdateImage</html:radio>
						 &nbsp;<html:radio property="option3Img_editAction" value="remove" onclick="disableImgInputForID('ansThreeImage')">RemoveImage</html:radio>
						 &nbsp;<html:radio property="option3Img_editAction" value="none" onclick="disableImgInputForID('ansThreeImage')">Do Nothing</html:radio>
				...
				<td colspan="4">
					...
					<logic:equal value="1" property="isGraphics" name="ManageQuestionBean" >
						<br/><img id="option4_ImageValue" src="<html:rewrite page='/imageRender.do'/>?questionId=<%=qId %>&imagefor=<%=EducationConstant.IMAGE_FOR_OPTION4%>"
						  		   alt="NoImage" height="100" width="100"/>
						<br/><html:radio property="option4Img_editAction" value="update" onclick="enableImgInputForID('ansFourImage')">Add/UpdateImage</html:radio>
						 &nbsp;<html:radio property="option4Img_editAction" value="remove" onclick="disableImgInputForID('ansFourImage')">RemoveImage</html:radio>
						 &nbsp;<html:radio property="option4Img_editAction" value="none" onclick="disableImgInputForID('ansFourImage')">Do Nothing</html:radio>					  		   
				...
				<td colspan="4">
					...
					<logic:equal value="1" property="isGraphics" name="ManageQuestionBean" >
						<br/><img src="<html:rewrite page='/imageRender.do'/>?questionId=<%=qId %>&imagefor=<%=EducationConstant.IMAGE_FOR_OPTION5%>"
						  		   alt="NoImage" height="100" width="100"/>
						<br/><html:radio property="option5Img_editAction" value="update" onclick="enableImgInputForID('ansFiveImage')">Add/UpdateImage</html:radio>
						 &nbsp;<html:radio property="option5Img_editAction" value="remove" onclick="disableImgInputForID('ansFiveImage')">RemoveImage</html:radio>
						 &nbsp;<html:radio property="option5Img_editAction" value="none" onclick="disableImgInputForID('ansFiveImage')">Do Nothing</html:radio>
				...
				<td colspan="3">
					...
					<logic:equal value="1" property="isGraphics" name="ManageQuestionBean" >
						<br/><img id="ansExp_ImageValue" src="<html:rewrite page='/imageRender.do'/>?questionId=<%=qId %>&imagefor=<%=EducationConstant.IMAGE_FOR_ANSWER_EXPLANATION%>"
						  		   alt="NoImage" height="100" width="100"/>
						<br/><html:radio property="ansExpImg_editAction" value="update" onclick="enableImgInputForID('ansExplanation')">Add/UpdateImage</html:radio>
						 &nbsp;<html:radio property="ansExpImg_editAction" value="remove" onclick="disableImgInputForID('ansExplanation')">RemoveImage</html:radio>
						 &nbsp;<html:radio property="ansExpImg_editAction" value="none" onclick="disableImgInputForID('ansExplanation')">Do Nothing</html:radio>
			...
			<logic:present property="navigationFromGrid" name="ManageQuestionBean">
				<logic:empty property="navigationFromGrid" name="ManageQuestionBean">
					<tr>
						<td bgcolor="#FFFFFF">Save Options</td>				
