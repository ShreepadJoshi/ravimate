...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="10" bgcolor="#F0F0FF">
	...
	<tr>
		...
		<td width="71%"><label>
			...
			<html:text property="firstName" styleClass="input_field" styleId="firstName" />
	...
	<tr>
		...
		<td>
			<html:text property="lastName" styleClass="text" styleId="lastName" styleClass="input_field" />
	...
	<tr>
		...
		<td><bean:write name="FullRegistrationBean" property="regDate_displayFormat" /></td>
	</tr>
	
	<tr>
		<td colspan="2"><strong>Contact
		Information: </strong></td>
	</tr>
	<tr>
		<td class="input_label">Address:<span style="color: red">&#42;</span></td>
		<td>
			<html:textarea property="address" styleClass="input_field" styleId="address"/>
	...
	<tr>
		...
		<td>
			<html:text property="alternateEmailID" styleClass="input_field" styleId="alternateEmailID" />
		...
		<td colspan="2">			
			<logic:notEmpty property="navFromPage" name="FullRegistrationBean">
				...
				<logic:equal value="<%=EducationConstant.AFFILIATE_USER_ROLE %>" property="navFromPage" name="FullRegistrationBean">
					<html:submit property="action" value="SaveLogin" styleClass="url"/>					
				</logic:equal>
