...
public class PaginatedListImpl implements IExtendedPaginatedList {
    ...
    /**
     * Returns search criteria If any for page 
     * @return
     */
    ...
    /**
     * Sets search criteria If any for page 
     * @param searchCriteria - This class is written in Action class where we store search criteria
     */
