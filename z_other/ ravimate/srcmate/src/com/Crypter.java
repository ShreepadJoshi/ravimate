...
public class Crypter {
	...
	public static void main(String[] args) {
		...
		String iv = null;
		String salt = null;
		Crypter en = new Crypter(mPassword);
		 ...
		 * decrypt file
		 */
		Crypter dc = new Crypter(mPassword);
	...
	public void WriteEncryptedFile(InputStream inputStream, OutputStream outputStream)
		...
		try {
			 ...
			 *
			 * in order to do 256 bit crypto, you have to muck with the files
			 * for Java's "unlimted security" The end user must also install
			 * them (not compiled in) so beware. see here:
			 * http://www.javamex.com/tutorials/cryptography/
			 * unrestricted_policy_files.shtml
			 */
			...
			/*
			 * Create the Encryption cipher object and store as a member
			 * variable
			 */
			...
			// finalize the encryption since we've done it in blocks of
			// MAX_FILE_BUF
